...
HDRS += src/ForestReader.h src/HighForestReader.h src/SkimForestReader.h src/DijetHistograms.h src/DijetAnalyzer.h src/ConfigurationCard.h src/TrkCorr.h src/TrkSettings.h src/JffCorrection.h
