...
./addHistogramRange.sh $FOLDERNAME $BASENAME 401 475

hadd -ff ${BASENAME}.root ${BASENAME}_1-100.root ${BASENAME}_101-200.root ${BASENAME}_201-300.root ${BASENAME}_301-400.root ${BASENAME}_401-475.root

rm ${BASENAME}_1-100.root
rm ${BASENAME}_101-200.root
rm ${BASENAME}_201-300.root
rm ${BASENAME}_301-400.root
rm ${BASENAME}_401-475.root

root -l -b -q 'skimJCardDihadron.C("'${BASENAME}'.root",475)'
