...
hadd -ff ${BASENAME}.root ${BASENAME}_1-10.root ${BASENAME}_11-20.root ${BASENAME}_21-30.root ${BASENAME}_31-40.root ${BASENAME}_41-50.root ${BASENAME}_51-60.root ${BASENAME}_61-70.root ${BASENAME}_71-80.root ${BASENAME}_81-90.root ${BASENAME}_91-100.root ${BASENAME}_101-110.root ${BASENAME}_111-120.root
...
root -l -b -q 'skimJCardDihadron.C("'${BASENAME}'.root",120)'
