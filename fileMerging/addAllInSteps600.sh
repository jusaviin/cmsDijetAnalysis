...
hadd -ff ${BASENAME}.root ${BASENAME}_1-100.root ${BASENAME}_101-200.root ${BASENAME}_201-300.root ${BASENAME}_301-400.root ${BASENAME}_401-500.root ${BASENAME}_501-600.root
...
root -l -b -q 'skimJCard.C("'${BASENAME}'.root",600)'
