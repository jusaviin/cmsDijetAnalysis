...
#hadd -ff ${BASENAME}_201-250.root ${BASENAME}_201-210.root ${BASENAME}_211-220.root ${BASENAME}_221-230.root ${BASENAME}_231-240.root ${BASENAME}_241-250.root

hadd -ff ${BASENAME}.root ${BASENAME}_1-100.root ${BASENAME}_101-200.root ${BASENAME}_201-250.root
...
rm ${BASENAME}_201-250.root

root -l -b -q 'skimJCard.C("'${BASENAME}'.root",250)'
