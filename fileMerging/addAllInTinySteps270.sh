...
./addHistogramRange.sh $FOLDERNAME $BASENAME 201 210
./addHistogramRange.sh $FOLDERNAME $BASENAME 211 220
./addHistogramRange.sh $FOLDERNAME $BASENAME 221 230
./addHistogramRange.sh $FOLDERNAME $BASENAME 231 240
./addHistogramRange.sh $FOLDERNAME $BASENAME 241 250
./addHistogramRange.sh $FOLDERNAME $BASENAME 251 260
./addHistogramRange.sh $FOLDERNAME $BASENAME 261 270
...
hadd -ff ${BASENAME}_201-270.root ${BASENAME}_201-210.root ${BASENAME}_211-220.root ${BASENAME}_221-230.root ${BASENAME}_231-240.root ${BASENAME}_241-250.root ${BASENAME}_251-260.root ${BASENAME}_261-270.root

hadd -ff ${BASENAME}.root ${BASENAME}_1-100.root ${BASENAME}_101-200.root ${BASENAME}_201-270.root
...
rm ${BASENAME}_201-210.root
rm ${BASENAME}_211-220.root
rm ${BASENAME}_221-230.root
rm ${BASENAME}_231-240.root
rm ${BASENAME}_241-250.root
rm ${BASENAME}_251-260.root
rm ${BASENAME}_261-270.root
rm ${BASENAME}_1-100.root
rm ${BASENAME}_101-200.root
rm ${BASENAME}_201-270.root

root -l -b -q 'skimJCard.C("'${BASENAME}'.root",270)'
