...
./addHistogramRange.sh $FOLDERNAME $BASENAME 31 43
./addHistogramRange.sh $FOLDERNAME $BASENAME 45 50
...
hadd -ff ${BASENAME}.root ${BASENAME}_1-10.root ${BASENAME}_11-20.root ${BASENAME}_21-30.root ${BASENAME}_31-43.root ${BASENAME}_45-50.root ${BASENAME}_51-60.root ${BASENAME}_61-70.root ${BASENAME}_71-80.root ${BASENAME}_81-90.root ${BASENAME}_91-100.root ${BASENAME}_101-110.root ${BASENAME}_111-120.root

rm ${BASENAME}_1-10.root
rm ${BASENAME}_11-20.root
rm ${BASENAME}_21-30.root
rm ${BASENAME}_31-43.root
rm ${BASENAME}_45-50.root
...
root -l -b -q 'skimJCard.C("'${BASENAME}'.root",119)'
