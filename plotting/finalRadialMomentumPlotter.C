...
void finalRadialMomentumPlotter(){
  ...
  auto f = TFile::Open("hin-19-013_jetShapes_ppJECupdate.root");
  ...
  TString format = ".pdf";
  paperFig1Plotter("figures/radialMomentum_leadingAndSubleadingCombined_finalStyleUpdates2"+format, ld_js, ld_sum, sub_js, sub_sum, vlabel);
  paperFig2Plotter("figures/radialMomentumRatio_leadingAndSubleadingCombined_finalStyleUpdates2"+format, ld_sum, sub_sum);
}
