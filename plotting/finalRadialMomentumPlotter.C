...
void finalRadialMomentumPlotter(){
  ...
  TString format = ".pdf";
  paperFig1Plotter("figures/radialMomentum_leadingAndSubleadingCombined_preliminaryTag"+format, ld_js, ld_sum, sub_js, sub_sum, vlabel);
  paperFig2Plotter("figures/radialMomentumRatio_leadingAndSubleadingCombined_preliminaryTag"+format, ld_sum, sub_sum);
}
