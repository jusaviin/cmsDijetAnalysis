#include "DijetHistogramManager.h" R__LOAD_LIBRARY(DrawingClasses.so)
...
void finalBigAsymmetryPlotter_v1(){
		...
		TFile *ppFile = TFile::Open(dir_str+"/ppData2017_highForest_pfJets_20EventsMixed_finalTrackCorr_xjBins_JECv4_wtaAxis_tunedSeagull_allCorrections_processed_2019-10-17.root");
		TFile *pbpbFile = TFile::Open(dir_str+"/dijetPbPb2018_akFlowPuCs4PFJets_noUncOrInc_25eveMix_100trig_JECv6_xjBins_wtaAxis_allCorrectionsWithShifterCentrality_trackDeltaRonlyInLowPt_processed_2019-10-17.root");

		TFile *ppUncertaintyFile = TFile::Open(dir_str+"/systematicUncertaintyForPp_20percentSpillJff_2019-09-30.root");
		TFile *pbpbUncertaintyFile = TFile::Open(dir_str+"/systematicUncertaintyForPbPb_15percentSpill5Jff_2019-10-14.root");
