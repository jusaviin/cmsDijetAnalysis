...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data","Pol1 10", "Pol2 10", "Pol1 100", "Pol2 100", "MC, Q < 2.5", "MC, Q < 2.8", "MC, Q < 2.8", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
