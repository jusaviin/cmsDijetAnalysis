...
void longRangeGraphPlotter(){
  ...
  TString graphFileName = "flowGraphs_PbPbMC2018_noCentShift_subeNon0_caloJets_noQcut_onlyDihadron_correctedJetHadron_correctedDihadron_cumulativePtBins_2021-04-01.root";
  ...
  TString fileLegend[] = {"Old MC", "New MC", "pol3", "pol4", "pol6", "pol10", "MC, Q < 2.8", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
