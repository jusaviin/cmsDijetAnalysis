...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data", "MC 0%",  "MC 1%", "MC 2%", "MC 3%", "MC 4%", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
