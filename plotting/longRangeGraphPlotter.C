...
void longRangeGraphPlotter(){
  ...
  TString graphFileName = "flowGraphs_PbPb2018MC_caloJets_4pCentShift_subeNon0_multiplicityWeight_2022-01-26.root";
  ...
  TString fileLegend[] = {"Reco jets", "Gen jets", "MC, 4% shift",  "MC, PfCs jets, #eta reflect scale 2", "MC, calo",  "MC control", "MC control2", "MC 16%", "Flow MC", "MC+5% Q < 2.8"};
