...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data", "MC #alpha = 0.8",  "MC #alpha = 0.92", "MC #alpha = 0.94", "MC #alpha = 0.96", "MC #alpha = 1", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
          ...
          if(drawHadronVnFileComparison){
            ...
            if(drawRatios){
              ...
              for(int iFile = 0; iFile < maxFileIndex; iFile++){
                ...
                if(iFile == 0){
                  drawer->DrawGraph(ratioGraphHadron[iFile][iAsymmetry][iCentrality], 0, maxTrackPt, 0.95, 1.05, "Track p_{T} (GeV)", "Hadron v_{2} ratio", " ", "p");
                } else {
