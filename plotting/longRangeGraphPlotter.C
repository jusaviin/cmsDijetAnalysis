...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data","Weighted", "MC, Q < 1.5", "MC, Q < 2", "MC, Q < 2.2", "MC, Q < 2.5", "MC, Q < 2.8", "MC, Q < 2.8", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
