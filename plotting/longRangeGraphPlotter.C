...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Calo jet", "Flow jet", "Flow jet, include calo dijet", "Flow MC", "MC+5%, Q < 2.2",  "MC+5%, Q < 2.5", "MC+5% Q < 2.8"};
