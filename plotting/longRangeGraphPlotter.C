...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data", "MC 0%", "MC 5%", "MC 10%", "MC 15%", "MC 20%", "MC 5%", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
