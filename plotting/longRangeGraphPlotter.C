...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data", "MC #alpha = 1, min = 0.25", "MC #alpha = 1", "MC #alpha = 1, max = 110", "MC #alpha = 2", "MC 5%", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
