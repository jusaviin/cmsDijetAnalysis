...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data","Weighted 2", "Weighted 5", "Weighted 10", "MC, Q < 2.2", "MC, Q < 2.5", "MC, Q < 2.8", "MC, Q < 2.8", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
