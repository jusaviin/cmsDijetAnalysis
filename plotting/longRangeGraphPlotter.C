...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Calo jets", "Smeared axis", "MC+4%, Q > 2.2", "MC+4%, Q > 2.8", "MC+4%, Q > 3.3",  "MC+4%, Q < 2.8"};
