...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Calo jets", "Flow jets", "Calo MC", "Flow MC", "MC+5%, Q < 2.2",  "MC+5%, Q < 2.5", "MC+5% Q < 2.8"};
  ...
  TString saveComment = "_caloFlowComparisonCentral";              // String to be added to saved file names
