...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data", "MC #alpha = 0.25", "MC #alpha = 0.5", "MC #alpha = 1", "MC #alpha = 2", "MC 4%", "MC 5%", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
