...
// pT 1.1    1.4    1.7    2.2    2.7    3.2    3.7    4.4    5.4    6.4    7.4
  ...
  if(drawGraphVnComparison){
    ...
    if(drawBigCanvas){
      ...
      if(leadSubTitles){
        mainTitle->DrawLatexNDC(0.09, 0.92, "p_{T}^{lead} > 120 GeV");
        mainTitle->DrawLatexNDC(0.09, 0.84, "p_{T}^{sub} > 50 GeV");
        mainTitle->DrawLatexNDC(0.09, 0.76, "#Delta#varphi > #frac{5#pi}{6}");
      } else {
...
//              }
            ...
            if(drawRatios){
              ...
              for(int iFile = 0; iFile < maxFileIndex; iFile++){
                ...
                if(iFile == 0){
                  drawer->DrawGraph(ratioGraphJet[iFile][iAsymmetry][iCentrality], 0, maxTrackPt, 0.9, 1.1, "Track p_{T} (GeV)", Form("Jet v_{%d} ratio", iFlow+1), " ", "p");
                } else {
