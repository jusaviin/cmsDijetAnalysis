...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data", "MC 0%", "MC 4%", "MC 16%", "MC 17%", "MC 18%", "MC 19%", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
