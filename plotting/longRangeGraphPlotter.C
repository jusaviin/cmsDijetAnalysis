...
void longRangeGraphPlotter(){
  ...
  TString fileLegend[] = {"Data", "No track eff", "MC 1%", "MC 2%", "MC 3%", "MC 4%", "MC 5%", "PfCs MC", "Flow MC", "MC+5% Q < 2.8"};
