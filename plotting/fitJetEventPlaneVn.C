...
void fitJetEventPlaneVn(){
  ...
  inputFile[0] = TFile::Open("eventPlaneCorrelation/jetEventPlaneDeltaPhi_PbPbMC2018_genJets_fakeJetV3_multiplicityWeight_allEventPlanes_jetEta1v3_2022-02-03.root");
