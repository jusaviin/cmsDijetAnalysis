...
void longRangeSystematicExplorer(){
  ...
  TGraphErrors *jetVnUncertainty[nFiles][LongRangeSystematicOrganizer::knUncertaintySources][maxVn];
  ...
  for(int iFile = 0; iFile < nFiles; iFile++){
    ...
    for(int iUncertainty = 0; iUncertainty < LongRangeSystematicOrganizer::knUncertaintySources; iUncertainty++){
      for(int iFlow = firstDrawnVn-1; iFlow <= lastDrawnVn-1; iFlow++){
        jetVnUncertainty[iFile][iUncertainty][iFlow] = uncertaintyOrganizer[iFile]->GetLongRangeSystematicUncertainty(iFlow, iUncertainty);
        ...
        if(jetVnUncertainty[iFile][iUncertainty][iFlow] == NULL){
          ...
          cout << "It seems that I could not find the graph for v" << iFlow+1 << " " << uncertaintyOrganizer[iFile]->GetLongRangeUncertaintyName(iUncertainty) << endl;
        }
  ...
  for(int iFile = 0; iFile < nFiles; iFile++){
    for(int iCentrality = 0; iCentrality < nCentralityBins; iCentrality++){
      for(int iFlow = 0; iFlow < maxVn; iFlow++){
        ...
        systematicIllustrationAbsolute[iFile][iFlow][iCentrality] = new TH1D(histogramName, histogramName, LongRangeSystematicOrganizer::knUncertaintySources, -0.5, LongRangeSystematicOrganizer::knUncertaintySources-0.5);
        ...
        systematicIllustrationRelative[iFile][iFlow][iCentrality] = new TH1D(histogramName, histogramName, LongRangeSystematicOrganizer::knUncertaintySources, -0.5, LongRangeSystematicOrganizer::knUncertaintySources-0.5);
        ...
        for(int iUncertainty = 0; iUncertainty < LongRangeSystematicOrganizer::knUncertaintySources; iUncertainty++){
          ...
          systematicIllustrationAbsolute[iFile][iFlow][iCentrality]->GetXaxis()->ChangeLabel(iUncertainty+1, 315, -1, -1, -1, -1, uncertaintyOrganizer[iFile]->GetUncertaintyAxisName(iUncertainty));
          systematicIllustrationRelative[iFile][iFlow][iCentrality]->GetXaxis()->ChangeLabel(iUncertainty+1, 315, -1, -1, -1, -1, uncertaintyOrganizer[iFile]->GetUncertaintyAxisName(iUncertainty));
    ...
    for(int iFlow = firstDrawnVn-1; iFlow <= lastDrawnVn-1; iFlow++){
      for(int iCentrality = 0; iCentrality < nCentralityBins; iCentrality++){
        ...
        for(int iFile = 0; iFile < nFiles; iFile++){
          ...
          highValue = systematicIllustrationRelative[iFile][iFlow][iCentrality]->GetBinContent(LongRangeSystematicOrganizer::kAll+1);
    ...
    for(int iFlow = firstDrawnVn-1; iFlow <= lastDrawnVn-1; iFlow++){
      for(int iCentrality = 0; iCentrality < nCentralityBins; iCentrality++){
        ...
        for(int iFile = 0; iFile < nFiles; iFile++){
          ...
          highValue = systematicIllustrationAbsolute[iFile][iFlow][iCentrality]->GetBinContent(LongRangeSystematicOrganizer::kAll+1);
          highValue = highValue + 0.1 * highValue;
          if(highValue > maxValue) maxValue = highValue;
        }
