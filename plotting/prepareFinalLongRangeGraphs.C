...
void prepareFinalLongRangeGraphs(){
  ...
  dihadronFileName[0] = "data/PbPbMC2018_RecoGen_akCaloJet_dihadron_noCentShift_subeNon0_improvisedMixing_noCorrections_processed_2021-06-25_test.root";
  ...
  TString outputFileName = "flowGraphs/flowGraphs_PbPbMC2018_noCentShift_subeNon0_caloJets_onlyDihadron_correctedJetHadron_correctedDihadron_cumulativePtBins_2021-06-28.root";
