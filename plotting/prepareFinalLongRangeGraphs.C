...
void prepareFinalLongRangeGraphs(){
  ...
  const char* qVectorTag = "_qGaussA095B2Max100";
  
  // File for Vn from jet-hadron correlations
  TString jetHadronFileName[4];
  jetHadronFileName[0] = "data/PbPbMC2018_RecoGen_akCaloJet_onlyRegular_4pCentShift_improvisedMixing_subeNon0_qVectorWeightTune0-10_noCorrections_processed_2021-06-30.root";
  ...
  dihadronFileName[0] = Form("data/PbPbMC2018_RecoGen_akCaloJet_dihadron_4pCentShift_subeNon0_improvisedMixing%s_noCorrections_processed_2021-06-29_test.root",qVectorTag);
  ...
  TString outputFileName = Form("flowGraphs/flowGraphs_PbPbMC2018_4pCentShift%s_subeNon0_caloJets_onlyDihadron_correctedJetHadron_correctedDihadron_cumulativePtBins_2021-06-30.root", qVectorTag);
