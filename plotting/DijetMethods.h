...
public:
  ...
  TH2D* GetSpilloverCorrection(TH2D *onlyHydjetHistogram, double spilloverEtaFitRange = 1.5, double spilloverPhiFitRange = 1.5);  // Get the spillover correction from only hydjet histogram
