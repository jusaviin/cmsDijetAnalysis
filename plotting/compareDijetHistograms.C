...
void compareDijetHistograms(){
  ...
  const char* figureComment = "_sube0Match";
  ...
  double minZoom = 0.95;
  double maxZoom = 1.05;
  TString ratioLabel = "Match / Color";
