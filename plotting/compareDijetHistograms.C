...
void compareDijetHistograms(){
  ...
  const char* figureComment = "_spilloverComparison";
  ...
  double minZoom = 0;
  double maxZoom = 2;
  TString ratioLabel = "Spillover / No";
  ...
  int asymmetryBin = 0; // Asymmetry selection: -1 = No selection, 0 = 0 < xj < 0.6, 1 = 0.6 < xj < 0.8, 2 = 0.8 < xj < 1. For inclusive, set this to 0 to select only jets above 120 GeV.
