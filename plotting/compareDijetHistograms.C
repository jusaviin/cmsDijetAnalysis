...
void compareDijetHistograms(){
  ...
  const char* figureComment = "_jecComparison";
  ...
  double minZoom = 0.5;
  double maxZoom = 1.5;
  TString ratioLabel = "JEC+- / Nominal";
  ...
  int asymmetryBin = 3; // Asymmetry selection: -1 = No selection, 0 = 0 < xj < 0.6, 1 = 0.6 < xj < 0.8, 2 = 0.8 < xj < 1. For inclusive, set this to 0 to select only jets above 120 GeV.
