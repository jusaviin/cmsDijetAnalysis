...
void compareDijetHistograms(){
  ...
  const char* figureComment = "_jffComparison";
  ...
  int asymmetryBin = 2; // Asymmetry selection: -1 = No selection, 0 = 0 < xj < 0.6, 1 = 0.6 < xj < 0.8, 2 = 0.8 < xj < 1. For inclusive, set this to 0 to select only jets above 120 GeV.
  ...
  uncertaintyProvider->ReadSystematicFile(TFile::Open("uncertainties/systematicUncertaintyForPbPbMC_RecoReco_5eveMix_mcMode_2019-12-10.root"));
