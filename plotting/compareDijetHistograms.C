...
void compareDijetHistograms(){
  ...
  const char* figureComment = "_jetWeightRecoGen";
  ...
  int lastDrawnCentralityBin = nCentralityBins-3;
  
  int firstDrawnTrackPtBin = 0;
  int lastDrawnTrackPtBin = nTrackPtBins-3;
  ...
  TString legendComment[nDatasets] = {/*"PbPb rawPt","PbPb L2Rel","PbPb L2Rel+Res",*/"pp","Pythia8" };
