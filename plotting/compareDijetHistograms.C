...
void compareDijetHistograms(){
  ...
  const char* figureComment = "_triggerComparison";
  ...
  double minZoom = 0.9;
  double maxZoom = 1.1;
  TString ratioLabel = "Jet80 / Jet100";
  ...
  TString legendComment[nDatasets] = {/*"PbPb rawPt","PbPb L2Rel","PbPb L2Rel+Res",*/"Jet100","Jet80"};
