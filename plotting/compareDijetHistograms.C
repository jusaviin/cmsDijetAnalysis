...
void compareDijetHistograms(){
  ...
  double minZoom = 0.0;
  double maxZoom = 1.2;
  TString ratioLabel = "Color / All HP";
  ...
  int scaleHistograms = 0; // 0 = Do not scale histograms. 1 = Scale integral to one. 2 = Scale average to one
