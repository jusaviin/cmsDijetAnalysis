...
void compareDijetHistograms(){
  ...
  const char* figureComment = "_smearingStudy";
  ...
  double minZoom = 0.7;
  double maxZoom = 1.3;
  TString ratioLabel = "Color / Nominal";
