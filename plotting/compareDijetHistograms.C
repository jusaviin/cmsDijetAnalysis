...
void compareDijetHistograms(){
  ...
  const char* figureComment = "_triggerPtComparison";
  ...
  double minZoom = 0.9;
  double maxZoom = 1.1;
  TString ratioLabel = "Color / Low p_{Tt}";
