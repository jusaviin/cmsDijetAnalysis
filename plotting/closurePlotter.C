...
void closurePlotter(){
  ...
  // data/PbPbMC_RecoReco_skims_pfJets_noMixing_processed_2019-01-04.root
  closureFile[kPbPb][kRecoGen] = TFile::Open("data/PbPbMC_RecoGen_akFlowPuCs4PFJet_noUncorr_improvisedMixing_noCorrections_wtaAxis_JECv6_processed_2019-09-26.root");
