...
./processHistogramsInSteps.sh "data/dijetPbPb_skims_pfJets_noUncorr_xj_noMixing_2019-03-04.root" "data/dijetPbPb_skims_pfJets_noCorrelations_xj_noMixing_processed_2019-03-04.root" false false
