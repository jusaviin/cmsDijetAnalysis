...
./processHistogramsInSteps.sh "data/PbPbMC_RecoGen_skims_pfJets_noUncorr_5eveImprovedMix_subeNon0_2019-02-15.root" "data/PbPbMC_RecoGen_skims_pfJets_noUncorr_5eveImprovedMix_onlySameAndMixed_processed.root" false false
