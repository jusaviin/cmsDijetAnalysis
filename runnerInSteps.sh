...
./processHistogramsInSteps.sh "data/dijetPbPb_skims_pfJets_noUncorr_improvedPoolMixing_noJetLimit_2019-01-09.root" "data/dijetPbPb_skims_pfJets_noUncorr_improvedPoolMixing_noJetLimit_improvedMixingNormalization_revisedSpilloverFit_processed_2019-01-09.root" true true
#./processHistogramsInSteps.sh "data/dijet_pp_highForest_pfJets_2018-12-03.root" "data/dijet_pp_highForest_pfJets_smoothedMixing_noCorrections_2019-01-07.root" false false
