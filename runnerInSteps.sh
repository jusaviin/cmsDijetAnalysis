...
./processHistogramsInSteps.sh "data/dijetPbPb_pfJets_noInclusiveOrUncorrected_2018-10-19.root" "data/dijetPbPb_pfJets_noInclusiveOrUncorrected_noCorrections_smoothedMixing_processed_2018-11-06.root" false false
